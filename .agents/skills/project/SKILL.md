...
```
Read .Codex/memory/design-intelligence/revision-patterns.md → anticipate changes
Read .Codex/memory/design-intelligence/rules.md → apply validated + promoted rules
```
...
2. Read `design-intelligence/rules.md` → auto-promote any rule with 3+ validations:
   - Design rule → append to `AGENTS.md` Design Philosophy
   - Agent rule → append to relevant `.Codex/agents/*.md`
