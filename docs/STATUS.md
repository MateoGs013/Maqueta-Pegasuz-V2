...
- The quality loop now has a canonical refresh step, but multimodal critic integration is still specified rather than truly model-driven.
...
3. Replace heuristic critic refresh with true multimodal critic output
